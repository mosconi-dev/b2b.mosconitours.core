...
class TieredPricingTest extends TestCase
{
    ...
    private function ruleWith(array $bands, TierMode $mode = TierMode::Whole): PricingRule
    {
    ...
    private function sell(float $net): string
    {
    ...
    private static function params(array $bands, TierMode $mode = TierMode::Whole): array
    {
        return ['mode' => $mode->value, 'bands' => array_map(fn (array $band): array => [
