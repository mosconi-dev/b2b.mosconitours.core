{{--
    ...
    Pass $steps to relabel it for another product. Hotels do: a hotel has rooms inside
    it, so choosing one is two steps, and there is nothing to upsell where flights sell
    seats and baggage. The shape stays identical on purpose — an agent who has learned
    one wizard has learned both.
--}}
@php
