<x-app-layout>
    <x-slot name="header">
        <x-page-heading title="Load Requests" subtitle="Wallet top-ups awaiting review, and everything already decided.">
            ...
            @if ($pendingCount > 0)
                <span class="inline-flex shrink-0 items-center rounded-full bg-amber-50 px-2 py-0.5 text-xs font-medium text-amber-700 ring-1 ring-inset ring-amber-600/20">
